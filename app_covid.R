...
dat1$type <- with(dat1, ifelse(SpecificAcquisition %in% c("Community","Secondary"),
                               "Community",
                               ifelse(SpecificAcquisition == "Travel", "Travel",NA)))
               ...
               tabsetPanel(
                 ...
                 tabPanel("Interpretation",
                          helpText("This graph represents the daily COVID case count in Alaska (yellow).",
                                   ...
                                   "The blue dotted line represents the predicted daily case trajectory (assuming exponential growth),",
                                   "with the grey band representing the 95% Confidence Interval (estimate range) of the projection.",
                                   br(),
                                   br(),
                                   "The projection statistics represent the estimated number of days with upper and lower",
                                   "confidence intervals (CI) to cut the daily observed case counts in half.")
                          )))),
               ...
               tabsetPanel(
                 ...
                 tabPanel("Interpretation",
                          helpText("This graph represents the cumulative COVID case counts in Alaska (yellow).",
                                   ...
                                   "7 days, which was not included in the analysis due to incomplete data/delay in reporting.",
                                   "The blue dotted line represents the predicted cumulative daily case trajectory (assuming exponential growth),",
                                   "with the grey band representing the 95% Confidence Interval (estimate range) of the projection.",
                                   br(),
                                   br(),
                                   "The projection statistics represent the estimated number of days with upper and lower",
                                   "confidence intervals (CI) to double the cumuative observed case counts.")
                          )))),
