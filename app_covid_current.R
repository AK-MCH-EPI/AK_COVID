...
server <- shinyServer(function(input, output) {
  ...
  url <- "https://services1.arcgis.com/WzFsmainVTuD5KML/arcgis/rest/services/COVID_Cases_public/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json"
  ...
  dat1 <- tibble::as_tibble(da$features$attributes) 
...
#### this uses the max date from the testing data.
  ...
  url_x <- "https://opendata.arcgis.com/datasets/ed5ca233976a4dcda3f38a24214216a7_0/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json"
  ...
  dat1_x <- tibble::as_tibble(da_x$features$attributes) 
