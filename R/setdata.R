...
#  dat1$ReportDate <- as.Date(with(dat1, ifelse(OnsetDateReplaced == 1, dat1$OnsetDate,
...
# 
# dist <- round(rtgamma(50000, shape = 3, truncation = 14))
# 
...
dat1$OnsetDate1 <- dat1$OnsetDate
